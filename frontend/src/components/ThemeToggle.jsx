...
// We persist the preference in localStorage so it survives page refreshes.
...
const ThemeToggle = () => {
  ...
  // Tailwind's darkMode: 'class' uses this to activate dark styles
  useEffect(() => {
    if (isDark) {
  ...
  return (
    <button
      ...
      className="w-9 h-9 rounded-xl flex items-center justify-center bg-gray-100 dark:bg-gray-800 
                 hover:bg-gray-200 dark:hover:bg-gray-700 transition-all duration-200 active:scale-95"
